  ...
  return (
    <div className='flex  justify-center bg-gray-700 h-screen w-screen  pt-10' >
      ...
      <div id='drop2' className='h-[90vh] w-96 bg-slate-900 origin-top duration-500 flex p-5 rounded-xl items-center flex-col'>
        ...
        <div  onClick={()=>{setLarge(!large)}} className='h-12 origin-top duration-500 w-12 rounded-full bg-gradient-to-r from-[#6EE7B7] via-[#3B82F6] to-[#9333EA] flex justify-center items-center mt-[30rem] text-white text-2xl font-bold cursor-pointer'>↑</div>
      ...
      <div id='drop2' className='h-[30vh] w-96 origin-bottom duration-500 bg-slate-900 flex p-5 rounded-xl flex-col items-center '>
        <p id='demo' className='text-white text-5xl text-center pt-6'></p>
        <div  onClick={()=>{setLarge(!large)}} className='h-12 w-12 origin-bottom duration-500 rounded-full bg-gradient-to-r from-[#6EE7B7] via-[#3B82F6] to-[#9333EA] flex justify-center items-center mt-12 text-white text-2xl font-bold cursor-pointer'>↓</div>
    </div></div>}
